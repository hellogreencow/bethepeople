    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-purple-950 text-white relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4 py-4">
          ...
          {isMobile && (
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-4 mb-4 mx-4 rounded-2xl">
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full font-medium transition-all text-xs flex items-center gap-1 ${
                      dataSource === 'real' && realOpportunities.length > 0
                        ? 'bg-green-500/20 text-green-300 border border-green-500/30'
                        : 'bg-white/5 text-white/50 border border-white/10 hover:bg-white/10 disabled:opacity-50'
                    }`}
                  >
                    {isLoadingReal ? (
                      <>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-white font-bold text-sm">{user?.stats.points || 280}</span>
                    </div>
                    <div className="flex items-center gap-1">
          ...
          {/* Compact Header Section - Desktop Only */}
          {!isMobile && (
              ...
              >
                ...
                {user && (
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 bg-white/10 backdrop-blur-sm rounded-lg hover:bg-white/20 transition-colors text-sm"
                  >
                    <MapPin className="h-4 w-4" />
                    <span className="hidden md:inline">{user.preferences.location || 'Set Location'}</span>
                    <span className="hidden md:inline text-white/50">({searchRadius}mi)</span>
                  </button>
                )}
