...
const MobileSwipeInterface: React.FC<MobileSwipeInterfaceProps> = ({
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="bg-white/10 backdrop-blur-xl border-t border-white/20 pt-4 px-4 pb-0 rounded-t-2xl" style={{ paddingBottom: 'max(1rem, env(safe-area-inset-bottom))' }}>
